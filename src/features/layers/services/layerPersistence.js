...
export const saveLayers = async (layerList) => {
  try {
    ...
    const { saveLayersToIndexedDB } = await import('../../../shared/utils/storage/indexedDBStorage');
...
export const loadLayers = async () => {
  try {
    // Import IndexedDB utilities dynamically
    const { loadLayersFromIndexedDB, migrateFromLocalStorage } = await import('../../../shared/utils/storage/indexedDBStorage');
...
export const clearSavedLayers = async () => {
  try {
    const { clearIndexedDB } = await import('../../../shared/utils/storage/indexedDBStorage');
